...
function cpu_rvpipe_register(sim_p) {
    ...
    sim_p.signals[SIGNALS.PCWRITE] = {
        ...
        behavior: [create_op(BEHAVIORS.NOP),
            create_op(BEHAVIORS.MV, STATES.IF_FETCH_PC, STATES.OUT_MUX_JUMP_INT),
    ...
    sim_p.signals[SIGNALS.EPCWRITE] = {
        ...
        behavior: [create_op(BEHAVIORS.NOP),
            create_op(BEHAVIORS.MV, STATES.REG_EPC, STATES.OUT_EPC_MUX_IF_PC_IF_ID_PC) + create_op(BEHAVIORS.SET, STATES.BR, CSR.sepc.toString(), STATES.REG_EPC),
            create_op(BEHAVIORS.MV, STATES.REG_EPC, STATES.VAL_ZERO) + create_op(BEHAVIORS.SET, STATES.BR, CSR.sepc.toString(), STATES.REG_EPC),
            create_op(BEHAVIORS.NOP),],
    ...
    sim_p.behaviors[BEHAVIORS.DECO_IMM] = {
        ...
        operation: function (s_expr) {
            ...
            let oi = decode_instruction(sim_p.internal_states.FIRMWARE, sim_p.ctrl_states.ir, ins);
