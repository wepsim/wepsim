/*
 *  Copyright 2015-2023 Felix Garcia Carballeira, Alejandro Calderon Mateos, Javier Prieto Cepeda, Saul Alonso Monsalve, Javier Lopez Gomez
 *
 ...
 */
	 ...
	 */
        ...
        sim.ep.internal_states.ledm_state  = Array.from({length:sim.ep.internal_states.ledm_neltos},
						        () => ({color:0})) ;
        sim.ep.internal_states.ledm_colors = colors_clone('') ;
        ...
        sim.ep.states.LEDMSR = { name: "LEDMSR", verbal: "LEDM State Register",
                                 visible:false, nbits: "32", value: 0, default_value: 0,
                                 draw_data: [] };
        sim.ep.states.LEDMCR = { name: "LEDMCR", verbal: "LEDM Control Register",
                                 visible:false, nbits: "32", value: 0, default_value: 0,
                                 draw_data: [] };
        sim.ep.states.LEDMDR = { name: "LEDMDR", verbal: "LEDM Data Register",
                                 visible:false, nbits: "32", value: 0, default_value: 0,
                                 draw_data: [] };
        ...
        sim.ep.behaviors.LEDM_IOW   = { nparameters: 7,
							  ...
							  if (0x20 & bus_db)
							  {
                                                              ...
                                                              for (var p=0; p<neltos; p=p+4) {
                                                                   ...
                                                                   set_var(sim.ep.internal_states.ledm_state[p+0].color, (s & 0x000000FF) >> 0);
                                                                   set_var(sim.ep.internal_states.ledm_state[p+1].color, (s & 0x0000FF00) >> 8);
                                                                   set_var(sim.ep.internal_states.ledm_state[p+2].color, (s & 0x00FF0000) >> 16);
        ...
        sim.ep.behaviors.LEDM_SYNC  = { nparameters: 1,
                                       operation: function (s_expr)
                                                  {
