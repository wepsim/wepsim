 ...
 */
	...
	sim.ep.states["ACC_TIME"]    = { name:"ACC_TIME", verbal: "Accumulated CPU time",
                                         visible:false, nbits:"32", value:0,  default_value:0,
                                         draw_data: [] };
	sim.ep.states["TCPUKO"]      = { name:"TCPUKO", verbal: "Several Tristates to the internal data bus in CPU activated",
                                         visible:false, nbits:"32", value:0,  default_value:0,
                                         draw_data: [] };
	...
	/* TRI-STATES */
	 ...
	 sim.ep.signals["T1"]  = { name: "T1",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 0", "MV BUS_IB REG_MBR; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 0"],
	 ...
	 sim.ep.signals["T2"]  = { name: "T2",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 1", "MV BUS_IB REG_PC; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 1"],
	 ...
	 sim.ep.signals["T3"]  = { name: "T3",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 2", "MV BUS_IB SELEC_T3; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 2"],
	 ...
	 sim.ep.signals["T4"]  = { name: "T4",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 3", "MV BUS_IB REG_RT1; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 3"],
	 ...
	 sim.ep.signals["T5"]  = { name: "T5",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 4", "MV BUS_IB REG_RT2; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 4"],
	 ...
	 sim.ep.signals["T6"]  = { name: "T6",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 5", "MV BUS_IB ALU_C6; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 5"],
	 ...
	 sim.ep.signals["T7"]  = { name: "T7",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 6", "MV BUS_IB REG_RT3; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 6"],
	 ...
	 sim.ep.signals["T8"]  = { name: "T8",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 7", "MV BUS_IB REG_SR; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 7"],
	 ...
	 sim.ep.signals["T9"]  = { name: "T9",  visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 8", "MV BUS_IB RA_T9; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 8"],
	 ...
	 sim.ep.signals["T10"] = { name: "T10", visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 9", "MV BUS_IB RB_T10; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 9"],
	 ...
	 sim.ep.signals["T11"] = { name: "T11", visible: true, type: "L", value: 0, default_value:0, nbits: "1",
			       behavior: ["NOP; RST_BIT TCPUKO 10", "CP_FIELD BUS_IB REG_MICROINS/EXCODE; FIRE M7; FIRE M2; FIRE M1; SET_BIT TCPUKO 10"],
	...
	/* I/O Devices */
	 sim.ep.signals["IOR"]   = { name: "IOR", visible: true, type: "L", value: 0, default_value:0, nbits: "1",
				 behavior: ["NOP", "MOVE_BITS KBD_IOR 0 1 IOR; MOVE_BITS SCR_IOR 0 1 IOR; MOVE_BITS L3D_IOR 0 1 IOR; FIRE KBD_IOR; FIRE SCR_IOR; FIRE L3D_IOR"],
	...
	sim.ep.behaviors["SET_BIT"] = { nparameters: 3,
				     types: ["E", "I"],
				     operation: function(s_expr)
		                                {
						   var a = get_value(sim.ep.states[s_expr[1]]) << 0 ;
                                                   ...
                                                   var m = Math.pow(2, b) ;
						   set_value(sim.ep.states[s_expr[1]], a | m) ;
                                                },
                                        verbal: function (s_expr)
                                                {
                                                   return "" ;
	...
	sim.ep.behaviors["RST_BIT"] = { nparameters: 3,
				     types: ["E", "I"],
				     operation: function(s_expr)
		                                {
						   var a = get_value(sim.ep.states[s_expr[1]]) << 0 ;
