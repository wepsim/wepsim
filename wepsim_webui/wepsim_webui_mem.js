 ...
 */
        ...
        function light_refresh_main_memory ( memory, index, redraw )
        {
            if (redraw)
            {
                ...
                $("#mpval" + (index + 0)).html(svalue[0] + svalue[1]) ;
                $("#mpval" + (index + 1)).html(svalue[2] + svalue[3]) ;
                $("#mpval" + (index + 2)).html(svalue[4] + svalue[5]) ;
                $("#mpval" + (index + 3)).html(svalue[6] + svalue[7]) ;
            }
	    ...
	    if (is_current)
            ...
            else wcolor = "color:black; font-weight:normal; " ;
		 ...
		 valkeys[j] = addri.toString(16) ;
            ...
            for (var i=0; i<4; i++)
            {
                ...
                valuei = '<span id="' + idi[i] + '">' + value[i*2] + value[i*2+1] + '</span>' ;
		...
		"<div class='col-6 pr-2' align='right'  style='padding:5'>" + 
