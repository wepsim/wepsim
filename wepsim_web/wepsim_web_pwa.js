...
self.addEventListener('install',
				...
				caches.open(cacheName).then(function(cache) {
				    return cache.addAll([
                                        ...
                                        './wepsim-compact.html',
                                        './index.html',
                                        './examples/checklist/cl-mips_s2e2.txt',
                                        './examples/checklist/cl-mips_s3e3.txt',
                                        './examples/checklist/cl-mips_s1e3.txt',
                                        './examples/checklist/cl-mips_s4e2.txt',
                                        './examples/checklist/cl-mips_s4e1.txt',
                                        './examples/checklist/cl-mips_s1e4.txt',
                                        './examples/checklist/cl-mips_s3e4.txt',
                                        './examples/checklist/cl-mips_s1e2.txt',
                                        './examples/checklist/cl-mips_s2e4.txt',
                                        './examples/checklist/cl-mips_s3e2.txt',
                                        './examples/checklist/cl-mips_s3e1.txt',
                                        './examples/checklist/cl-mips_s2e3.txt',
                                        './examples/checklist/cl-mips_s1e1.txt',
                                        ...
                                        './examples/assembly/asm-mips_s4e4.txt',
                                        './examples/assembly/asm-mips_s2e3.txt',
                                        './examples/assembly/asm-mips_s1e4.txt',
                                        './examples/assembly/asm-mips_s1e1.txt',
                                        './examples/assembly/asm-mips_s6e1.txt',
                                        './examples/assembly/asm-mips_s4e2.txt',
                                        './examples/assembly/asm-mips_s3e3.txt',
                                        './examples/assembly/asm-mips_s6e3.txt',
                                        './examples/assembly/asm-mips_s1e3.txt',
                                        './examples/assembly/asm-mips_s2e4.txt',
                                        './examples/assembly/asm-mips_s3e1.txt',
                                        './examples/assembly/asm-mips_s1e2.txt',
                                        './examples/assembly/asm-mips_s2e1.txt',
                                        './examples/assembly/asm-mips_s4e3.txt',
                                        './examples/assembly/asm-mips_s2e2.txt',
                                        './examples/assembly/asm-mips_s5e1.txt',
                                        './examples/assembly/asm-mips_s4e1.txt',
                                        './examples/assembly/asm-mips_s3e2.txt',
                                        './examples/assembly/asm-mips_s6e2.txt',
                                        './examples/assembly/asm-mips_s5e2.txt',
                                        './examples/assembly/asm-rv32_r1e1.txt',
                                        './examples/assembly/asm-rv32_r1e2.txt',
                                        './examples/assembly/asm-rv32_r2e1.txt',
                                        './examples/assembly/asm-rv32_r3e1.txt',
