...
self.addEventListener('install',
				...
				caches.open(cacheName).then(function(cache) {
				    return cache.addAll([
                                        ...
                                        './wepsim-compact.html',
                                        './index.html',
                                        './examples/checklist/mips/cl-s2e2.txt',
                                        './examples/checklist/mips/cl-s3e3.txt',
                                        './examples/checklist/mips/cl-s1e3.txt',
                                        './examples/checklist/mips/cl-s4e2.txt',
                                        './examples/checklist/mips/cl-s4e1.txt',
                                        './examples/checklist/mips/cl-s1e4.txt',
                                        './examples/checklist/mips/cl-s3e4.txt',
                                        './examples/checklist/mips/cl-s1e2.txt',
                                        './examples/checklist/mips/cl-s2e4.txt',
                                        './examples/checklist/mips/cl-s3e2.txt',
                                        './examples/checklist/mips/cl-s3e1.txt',
                                        './examples/checklist/mips/cl-s2e3.txt',
                                        './examples/checklist/mips/cl-s1e1.txt',
                                        ...
                                        './examples/assembly/mips/asm-s4e4.txt',
                                        './examples/assembly/mips/asm-s2e3.txt',
                                        './examples/assembly/mips/asm-s1e4.txt',
                                        './examples/assembly/mips/asm-s1e1.txt',
                                        './examples/assembly/mips/asm-s6e1.txt',
                                        './examples/assembly/mips/asm-s4e2.txt',
                                        './examples/assembly/mips/asm-s3e3.txt',
                                        './examples/assembly/mips/asm-s6e3.txt',
                                        './examples/assembly/mips/asm-s1e3.txt',
                                        './examples/assembly/mips/asm-s2e4.txt',
                                        './examples/assembly/mips/asm-s3e1.txt',
                                        './examples/assembly/mips/asm-s1e2.txt',
                                        './examples/assembly/mips/asm-s2e1.txt',
                                        './examples/assembly/mips/asm-s4e3.txt',
                                        './examples/assembly/mips/asm-s2e2.txt',
                                        './examples/assembly/mips/asm-s4e1.txt',
                                        './examples/assembly/mips/asm-s3e2.txt',
                                        './examples/assembly/mips/asm-s6e2.txt',
                                        './examples/assembly/rv32/asm-r1e1.txt',
                                        './examples/assembly/rv32/asm-r1e2.txt',
                                        './examples/assembly/rv32/asm-r2e1.txt',
                                        './examples/assembly/rv32/asm-r3e1.txt',
                                        './examples/microcode/mips/mc-ep_bare.txt',
                                        './examples/microcode/mips/mc-ep_base.txt',
                                        './examples/microcode/mips/mc-ep_enhanced.txt',
                                        './examples/microcode/mips/mc-ep_interactive.txt',
                                        './examples/microcode/mips/mc-ep_os.txt',
                                        './examples/microcode/mips/mc-poc_base.txt',
                                        './examples/microcode/mips/mc-poc_os.txt',
                                        './examples/microcode/rv32/mc-ep_bare.txt',
                                        './examples/microcode/rv32/mc-ep_base.txt',
                                        './examples/microcode/rv32/mc-ep_min.txt',
                                        './examples/microcode/rv32/mc-poc_base.txt',
                                        './examples/microcode/rv32/mc-poc_min.txt',
