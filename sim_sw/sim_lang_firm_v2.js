...
function fv2_read_microprg ( context )
{
	   // {
	   //           (TA, R, BW=11, C1=1),
	   //    etiq:  (T2, C0),
...
function fv2_read_native ( context )
{
           var microprograma = [];
           var microcomments = [];
...
function fv2_find_first_cocop ( context, curr_instruction, first_co, last_co )
{
           var k = 0 ;
           var m = 0 ;
...
function fv2_loadFirmware (text)
{
           var ret = {} ;
...
function fv2_saveFirmware ( SIMWARE )
{
	var file = "";
...
function fv2_decode_instruction ( curr_firm, ep_ir, binstruction )
{
    var ret = {
                 "oinstruction": null,
                  op_code: 0,
