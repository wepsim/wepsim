/*
 *  Copyright 2015-2025 Saul Alonso Monsalve, Javier Prieto Cepeda, Felix Garcia Carballeira, Alejandro Calderon Mateos, Juan Banga Pardo
 *
	 ...
	 var tab       = "<span class='m-3'>&nbsp;</span>" ;
         ...
         for (let key in context.firmware)
         {
		  ...
		  for (let k=0; k<context.firmware[key].length; k++)
		  {
			   ...
			   if (candidate.finish.length > 18)
			        msg += candidate.finish.substr(0, 15) + "..." ;
