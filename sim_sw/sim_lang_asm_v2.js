 ...
 */
	...
	AV2_BYTE_LENGTH = 8 ;
	AV2_WORD_BYTES  = 4 ;
	AV2_WORD_LENGTH = WORD_BYTES * BYTE_LENGTH ;
...
/* directives */
function av2_get_datatype_size ( datatype )
{
...
function av2_is_directive_kindof ( text, kindof )
{
...
function av2_is_directive ( text )
{
	return (typeof directives[text] !== "undefined");
}

function av2_is_directive_segment ( text )
{
        return is_directive_kindof(text, 'segment') ;
}

function av2_is_directive_datatype ( text )
{
        return is_directive_kindof(text, 'datatype') ;
}

/* datatypes */
function av2_isDecimal ( n )
{
        var ret = {
                     'number':    0,
                     'isDecimal': false
...
function av2_get_decimal_value ( possible_value )
{
        var ret = {
                     'number':    0,
                     'isDecimal': true
...
function av2_decimal2binary ( number, size )
{
...
function av2_get_inm_value ( value )
{
        var ret1 = { } ;
        var ret  = {
                      'number':    0,
...
function av2_sum_array ( a )
{
	return a.reduce(function(a, b) { return a + b; }, 0);
}

function av2_get_candidate ( advance, instruction )
{
	var candidate = false;
	var candidates = {};
	var signatures = {};
...
function av2_reset_assembly (nwords)
{
	return "0".repeat(WORD_LENGTH*nwords);
}

function av2_assembly_replacement (machineCode, num_bits, startbit, stopbit, free_space)
{
...
function av2_assembly_co_cop(machineCode, co, cop)
{
...
function av2_writememory_and_reset ( mp, gen, nwords )
{
...
function av2_is_end_of_file (context)
{
...
function av2_read_data ( context, datosCU, ret )
{
...
function av2_read_text ( context, datosCU, ret )
{
	   //
	   //  .text
	   //
 ...
 *  Compile assembly
 */
function av2_simlang_compile (text, datosCU)
{
           var context = {} ;
	   context.line           	= 1 ;
	   context.error          	= null ;
