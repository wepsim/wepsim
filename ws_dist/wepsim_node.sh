#!/usr/bin/env node
   ...
   if (2 == process.argv.length)
   {
       ...
       console.log('   ./wepsim_node.sh run                   ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt') ;
       console.log('') ;
       console.log(' * Run some example and show the state on each assembly instruction executed:') ;
       console.log('   ./wepsim_node.sh stepbystep            ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt') ;
       console.log('') ;
       console.log(' * Run some example and show the state on each microinstruction executed:') ;
       console.log('   ./wepsim_node.sh microstepbymicrostep  ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt') ;
       console.log('') ;
       console.log(' * Check that some example actually works:') ;
       console.log('   ./wepsim_node.sh check                 ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt ./examples/checklist/cl-ep_s1_e1.txt') ;
       console.log('') ;
       console.log(' * Check that some example actually does not works:') ;
       console.log('   ./wepsim_node.sh check                 ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt ./examples/checklist/cl-ep_s1_e2.txt') ;
       console.log('') ;
       console.log('Additional Example:') ;
       console.log(' * Run some example and describe on each microinstruction the actions performed:') ;
       console.log('   ./wepsim_node.sh microstepverbalized   ep ./examples/microcode/mc-ep_s1_e1.txt ./examples/assembly/asm-ep_s1_e1.txt') ;
       console.log('') ;
