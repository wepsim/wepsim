#!/usr/bin/env node
   ...
   function ws_help_examples_basic ()
   {
       var o = '\n' +
               ...
               ' * ...final state:\n' +
               '   ./wepsim.sh -a run -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt\n' +
               ' * ...modified state on each assembly instruction executed:\n' +
               '   ./wepsim.sh -a stepbystep -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt\n' +
               ' * ...modified state on each microinstruction executed:\n' +
               '   ./wepsim.sh -a microstepbymicrostep -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt\n' +
               '\n' +
   ...
   function ws_help_examples_help ()
   {
       var o = '\n' +
               ...
               '   ./wepsim.sh -a help -m ep -f ./examples/microcode/mips/mc-ep_base.txt\n' +
   ...
   function ws_help_examples_check ()
   {
       var o = '\n' +
               ...
               '   ./wepsim.sh -a show-console -m ep -f ./examples/microcode/mips/mc-ep_os.txt -s ./examples/assembly/mips/asm-s4e1.txt\n' +
               '\n' +
               'Examples for checks at the end of some work:\n' +
               ' * Check that your work meets the expected final state (so it works):\n' +
               '   ./wepsim.sh -a check -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt -r ./examples/checklist/mips/cl-s1e1.txt\n' +
               '\n' +
   ...
   function ws_help_examples_checkpoint ()
   {
       var o = '\n' +
               ...
               '   ./wepsim.sh -a build-checkpoint -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt\n' +
               '\n' +
   ...
   function ws_help_examples_more ()
   {
       var o = '\n' +
               ...
               '   ./wepsim.sh -a microstepverbalized -m ep -f ./examples/microcode/mips/mc-ep_base.txt -s ./examples/assembly/mips/asm-s1e1.txt --verbal text\n' +
               '\n' +
