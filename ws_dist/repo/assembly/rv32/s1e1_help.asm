...
main:
    ...
    # notify: <ul>
    # notify: <li> srl   r1 r2  r3   <br># r1 = r2 >> r3 </li>
    # notify: <li> srli  r1 r2  imm  <br># r1 = r2 >> imm </li>
    # notify: <li> sll   r1 r2  r3   <br># r1 = r2 << r3 </li>
    # notify: <li> slli  r1 r2  imm  <br># r1 = r2 << imm </li>
    # notify: <li> sra   r1 r2  r3   <br># r1 = r2 >> r3 </li>
    # notify: <li> srai  r1 r2  imm  <br># r1 = r2 >> imm </li>
    # notify: </ul>
    li      a0, 0x010
    li      a1, 0x3
