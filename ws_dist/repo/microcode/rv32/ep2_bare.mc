...
begin
{
 ...
 csw_rt1: # push PC
          (MR=1, SELA=10, MA=0, MB=10, COP=1011, T6=1, SELC=10, LC=1, C0),
          (T2=1, M1=0, C1),
          (BW=11, TA=1, TD=1, W=1)
...
lui rd inm {
      ...
      help='rd = (inm << 12)',
      {
          ...
          (MA=1, MB=1, COP=1100, T6, C4),          # RT1 <- RT1 << 3
          (MA=1, MB=1, COP=1100, T6, C4),          # RT1 <- RT1 << 3
          (MA=1, MB=1, COP=1100, T6, C4),          # RT1 <- RT1 << 3
          (MA=1, MB=1, COP=1100, T6, LC=1, MR=0, SELC=10101, A0=1, B=1, C=0)
      }
}
...
auipc rd offset {
      ...
      help='rd = pc + (offset << 12)',
      {
          ...
          (MA=1, MB=1, COP=1100, T6, C4),          # RT1 <- RT1 << 3
          (MA=1, MB=1, COP=1100, T6, C4),          # RT1 <- RT1 << 3
          (MA=1, MB=1, COP=1100, T6, C5),          # RT2 <- RT1 << 3
          (T2, C4),                                # RT1 <- PC
          (MA=1, MB=10, COP=1011, T6, C4),         # RT1 <- RT1 - 4
          (MA=1, MB=1,  COP=1010, T6, MR=0, SelC=10101, LC=1, A0=1, B=1, C=0)
      }
}
...
jal rd offset {
      ...
      {
          (ExCODE=10, T11, C5),                     	    #       RT2 <- 2
          (SE=1, OFFSET=0, SIZE=10100, T3, C4),             #       RT1 <- offset
          (MA=1, MB=1, COP=1100, T6, C4),                   #       RT1 <- RT2*RT1
          (T2, MR=0, SelC=10101, LC, C5),                   # (rd, RT2) <- PC
          (MA=1, MB=1, COP=1010, T6, M2=0, C2, A0=1, B=1, C=0)
      }
}
...
jalr rd rs1 offset {
      ...
      help='rd = pc; pc = rs1 + 4*offset',
      {
          ...
          (ExCODE=10, T11, C5),                     	        # RT2 <- 2
          (MA=1, MB=1, COP=1100, T6, C4),                       # RT1 <- RT2*RT1
          (MR=0, SelB=10000, MA=1, COP=1010, T6, C5),           # RT2 <- offset + rs1
          (EXCODE=1, T11, C4),                                  # RT1 <- 1
          (MA=1, COP=11, T6, C4),                               # RT1 <- ~1 (0xFFFFFFFE)
          (MA=1, MB=1, COP=1, T6, M2=0, C2),                    # pc  <- RT2 & 0xFFFFFFFE
...
beq rs1 rs2 offset {
      ...
      {
          (T8, C5),
          (SELA=10101, SELB=10000, COP=1011, SELP=11, M7, C7),
          (A0=0, B=1, C=110, MADDR=bck2ftch),
          (T5, M7=0, C7),
          (SE=1, OFFSET=0, SIZE=10000, T3, C4),     # imm
          (ExCODE=10, T11, C5),                     # 2
          (MA=1, MB=1, COP=1100, T6, C4),           # immx2
          (T2, C5),                                 # pc
          (MA=1, MB=1, COP=1010, T6, C2, A0=1, B=1, C=0),
bck2ftch: (T5, M7=0, C7),
          (A0=1, B=1, C=0)
      }
...
bltu rs1 rs2 offset {
      ...
      {
          (T8, C5),
          (SELA=10101, SELB=10000, COP=10111, SELP=11, M7, C7),
...
addi rd rs1 inm {
      ...
      help='rd = rs1 + SignEx(inm)',
      {
          ...
          (MR=0, SELB=10000, MA=1, MB=0, COP=1010, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
xori rd rs1 inm {
      ...
      {
          (SE=1, OFFSET=0, SIZE=10000, T3=1, C5=1),
          (MR=0, SELA=10000, MA=0, MB=01, COP=100, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
ori rd rs1 inm {
      ...
      {
          (SE=1, OFFSET=0, SIZE=10000, T3=1, C5=1),
          (MR=0, SELA=10000, MA=0, MB=01, COP=10, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
andi rd rs1 inm {
      ...
      {
          (SE=1, OFFSET=0, SIZE=10000, T3=1, C5=1),
          (MR=0, SELA=10000, MA=0, MB=01, COP=1, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
add reg1 reg2 reg3 {
      ...
      help='r1 = r2 + r3',
      {
          (MR=0, SELA=1011, SELB=10000, MA=0, MB=0, COP=1010, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
sub reg1 reg2 reg3 {
      ...
      help='r1 = r2 - r3',
      {
          (MR=0, SELB=1011, SELA=10000, MA=0, MB=0, COP=1011, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
slt rd rs1 rs2 {
      ...
      help='rd = (rs1 < rs2) ? 1 : 0',
      {
          ...
          (T8, C5),
          (SELA=10000, SELB=1011, COP=1011, SELP=11, M7, C7),
...
sltu rd rs1 rs2 {
      ...
      help='rd = (ux(rs1) < ux(rs2)) ? 1 : 0',
      {
          (ExCode=0, T11, SelC=10101, MR=0, LC=1),
          (T8, C5),
          (SELA=10000, SELB=1011, COP=10111, SELP=11, M7, C7),
...
xor reg1 reg2 reg3 {
      ...
      help='r1 = r2 ^ r3',
      {
          (MR=0, SELA=1011, SELB=10000, MA=0, MB=0, COP=100, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
or reg1 reg2 reg3 {
      ...
      help='r1 = r2 | r3',
      {
          (MR=0, SELA=1011, SELB=10000, MA=0, MB=0, COP=10, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
and reg1 reg2 reg3 {
      ...
      help='r1 = r2 & r3',
      {
          (MR=0, SELA=1011, SELB=10000, MA=0, MB=0, COP=1, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
mul reg1 reg2 reg3 {
      ...
      help='reg1 = reg2 * reg3',
      {
          (MR=0, SELA=1011, SELB=10000, MA=0, MB=0, COP=1100, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
div reg1 reg2 reg3 {
      ...
      {
          # if (reg3 == 0)
          (MR=0, SELA=1011, MA=0, MB=11, COP=1100, SELP=11, M7, C7),
          (A0=0, B=0, C=110, MADDR=fpe1),
          # reg1 = reg2 / reg3, go fetch
          (MR=0, SELB=1011, SELA=10000, MA=0, MB=0, COP=1101, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0),
    fpe1: # RT1 <- ExCode=1
          (ExCode=1, T11, C4),
          # csw_rt1(2)
          (A0=0, B=1, C=0, MADDR=csw_rt1)
...
divu rd rs1 rs2 {
      ...
      help='reg1 = ux(reg2) / ux(reg3)',
      {
          ...
          # reg1 = reg2 / reg3, go fetch
          (MR=0, SELB=1011, SELA=10000, MA=0, MB=0, COP=11001, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0),
    fpe2: # RT1 <- ExCode=1
          (ExCode=1, T11, C4),
          # csw_rt1(2)
          (A0=0, B=1, C=0, MADDR=csw_rt1)
...
rem reg1 reg2 reg3 {
      ...
      help='reg1 = reg2 % reg3',
      {
            (MR=0, SELA=10000, SELB=1011, MA=0, MB=0, COP=1110, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fadd.s reg1 reg2 reg3 {
      ...
      help='r1 = r2 + r3',
      {
          (MR=0, SELA=10000, SELB=1011, MA=0, MB=0, COP=10000, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fsub.s reg1 reg2 reg3 {
      ...
      help='r1 = r2 - r3',
      {
          (MR=0, SELA=10000, SELB=1011, MA=0, MB=0, COP=10001, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fmul.s reg1 reg2 reg3 {
      ...
      help='r1 = r2 * r3',
      {
          (MR=0, SELA=10000, SELB=1011, MA=0, MB=0, COP=10010, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fdiv.s reg1 reg2 reg3 {
      ...
      help='r1 = r2 / r3',
      {
          (MR=0, SELA=10000, SELB=1011, MA=0, MB=0, COP=10011, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fcvt.w.s reg1 reg2 {
      ...
      {
          (MR=0, SELA=10000, MA=0, MB=11, COP=10100, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fcvt.s.w reg1 reg2 {
      ...
      {
          (MR=0, SELA=10000, MA=0, MB=10, COP=10100, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
...
fclass.s reg1 reg2 {
      ...
      help='r1 = classify(r2)',
      {
          (MR=0, SELA=10000, SELB=0000, MA=0, MB=0, COP=10101, T6=1, SELC=10101, LC=1, SELP=11, M7, C7, A0=1, B=1, C=0)
      }
}
