...
adds reg1 reg2 reg3 {
    ...
    reg3=reg(15,11),
    {
         (SelA=10000, SelB=01011, SelC=10101, MR=0, MA=0, MB=0 COP=1010, T6, LC, SELP=11, M7, C7),
         (A0=1, B=1, C=0)
    }
}
...
adds reg1 reg2 s16 {
    ...
    s16=imm(15,0),
    {
         ...
         (SelA=10000, SelC=10101, MR=0, MA=0, MB=01 COP=1010, T6, LC, SELP=11, M7, C7),
         (A0=1, B=1, C=0)
    }
}
...
mvns reg1 reg2 {
    ...
    reg2=reg(15,11),
    {
         (SelA=01011, SelC=10101, MR=0, MA=0, COP=0011, T6, LC, SELP=11, M7, C7),
         (A0=1, B=1, C=0)
    }
}
...
cmp reg reg {
    ...
    reg=reg(15,11),
    {
        (SelA=10101, SelB=01011, MR=0, MA=0, MB=0, COP=1011, SELP=11, M7, C7),
        (A0=1, B=1, C=0)
    }
}
