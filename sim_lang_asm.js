...
>>>>>>> fc22b2ad08102ea157a766398bcdeec71f08c5dd
{
	if (gen.byteWord >= 4) 
        {
...
<<<<<<< HEAD
				...
				byteWord+=size;
=======
				gen.machineCode = assembly_replacement(gen.machineCode, num_bits, BYTE_LENGTH*(size+gen.byteWord), BYTE_LENGTH*gen.byteWord, num_bits_free_space); 
