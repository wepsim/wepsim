 ...
 */
    ...
    i18n.eltos.compiler.hi = {
		...
		'NO TAG OR DIRECTIVE':		'उम्मीद टैग (एक्स :) या निर्देश (.x) लेकिन इसके बजाय इस टोकन पाया:',
		...
		'NO NUMBER OF BYTES':		'.space (प्राकृतिक संख्या), लेकिन पाया में आरक्षित करने के लिए बाइट्स की अपेक्षित संख्या:',
		...
		'UNKNOWN 1':		'एक अज्ञात त्रुटि हुई (1)',
		'UNKNOWN 2':		'अनपेक्षित त्रुटि (2)',
		'REMEMBER I. FORMAT':		'याद रखें कि अनुदेश प्रारूप के रूप में परिभाषित किया गया है:',
		'SEVERAL CANDIDATES':		'निर्देश और खेतों से अधिक संभव अनुदेश के साथ मेल खाते हैं। माइक्रोकोड की जांच करें। वर्तमान में, अनुदेश प्रारूप हो सकता है:',
