 ...
 */
    ...
    i18n.eltos.compiler.es = {
	   ...
	   "EMPTY MICROCODE":        "No hay microc'odigo",
           "EMPTY NAME LIST":        "Lista vac'ia de nombres asociada al registro: x=[]",
	   ...
	   "UNDEF. INSTR.":          "Instrucci'on no definida: ",
           "MORE 100 FIELDS":        "M'as de 100 campos en una sola instrucci'on.",
	   ...
	   "NO CO FIELD":            "Esperada palabra clave 'co' no encontrada",
           ...
           "INVALID PARAMETER":      "Par'ametro invalido: ",
           "ALLOWED PARAMETER":      "Solo se permite los siguientes campos: reg, num, inm, addr, address",
           "MISSING TOKEN ON":       "'token' no est'a despues de '(' en: ",
           "MISSING ) ON":           "')' no se encuentra en: ",
           "CO ALREADY USED":        "'co' ya se est'a usando por: ",
           ...
           "NO CO CODES":            "No hay c'odigos suficientes en 'co' para instrucciones",
           "NO LABEL MADDR":         "Etiqueta MADDR no encontrada: ",
           "INS. NAME":              "Nombre de instrucción: '",
           "NOT VALID FOR":          "' no es v'alido para: ",
