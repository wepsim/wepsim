 ...
 */
     ...
     import { dt_get_decimal_value,
              isDecimal,
              dt_get_imm_value,
              isFloat,
              dt_binary2format }           from "./datatypes.js";
     import { asm_setLabelContext,
              asm_langError,
              asm_getToken,
              asm_nextToken,
              wsasm_isEndOfFile,
              ...
              asm_resetComments,
              asm_getTokenType,
              asm_getLabelContext }         from "./lexical.js";
     import { i18n_get_TagFor }             from "../../wepsim_i18n/i18n.js";
     import { base_replaceAll }             from "../../sim_core/sim_core_ctrl.js";
     import { wsasm_is_directive_segment,
              wsasm_is_directive_datatype,
              wsasm_has_datatype_attr,
              wsasm_get_datatype_size,
              wsasm_is_directive }          from "./directives.js";
     import { decimal2binary,
              float2binary }                from "../../sim_core/sim_core_ui.js";
