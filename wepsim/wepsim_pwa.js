...
self.addEventListener('install', 
				...
				caches.open(cacheName).then(function(cache) {
					...
					'./images/stop/stop_despicable.gif',
                                        ...
                                        './examples/hardware/ep/ep_def.json',
                                        './examples/hardware/ep/images/controlunit6.svg',
                                        './examples/hardware/ep/images/processor6.svg',
                                        './examples/hardware/ep/images/cpu6.svg',
                                        ...
                                        './examples/hardware/ep/help/ep-en.html',
                                        './examples/hardware/ep/help/ep-es.html',
                                        './examples/hardware/poc/poc_def.json',
                                        './examples/hardware/poc/imagesc/controlunit2.svg',
                                        './examples/hardware/poc/imagesc/processor3.svg',
                                        './examples/hardware/poc/imagesc/cpu2.svg',
                                        ...
                                        './examples/hardware/poc/help/poc-en.html',
