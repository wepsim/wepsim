...
TEST_LIST+=('./ws_dist/wepsim.sh -a  check                 -m ep -f ./examples/microcode/mc-ep_base.txt -s ./examples/assembly/asm-ep_s1_e1.txt ./examples/checklist/cl-ep_s1_e1.txt')
TEST_LIST+=('./ws_dist/wepsim.sh -a  check                 -m ep -f ./examples/microcode/mc-ep_base.txt -s ./examples/assembly/asm-ep_s1_e1.txt ./examples/checklist/cl-ep_s1_e2.txt')
...
TEST_LIST+=('./ws_dist/wepsim.sh -a  check                 --checkpoint ./examples/checkpoint/tutorial_1.txt -ok ./examples/checklist/cl-ep_s1_e1.txt')
