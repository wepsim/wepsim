...
[![Release](https://img.shields.io/badge/Stable-2.3.8-green.svg)](https://github.com/acaldero/wepsim/releases/tag/v2.3.8)
...
+ From Linux/Unix command line, please:
  ...
  * Get WepSIM by executing:
    ```bash
    wget https://github.com/acaldero/wepsim/releases/download/v2.3.7/wepsim-2.3.7.zip
...
+ The following fragment is an example of how to use WepSIM from Google Colab cell (web version):
  ...
  def get_ws_url(asm, cpu):
    url = 'https://acaldero.github.io/wepsim/ws_dist/?'
    url = url + 'mode=ep&'
